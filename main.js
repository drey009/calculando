const display = document.querySelector("#display");// querrySelector pega o primeiro elemento dentro do documento
const buttons = document.querySelectorAll("button") // pega todos os elementos dentro do documento;
buttons.forEach((btn) => {
    btn.addEventListener ("click", () => {
        if (btn.id === "="){
            ...
            display.value += btn.id;// += concatena 
        }
    })
})
